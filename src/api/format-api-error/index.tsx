...
const formatAPIError = (error: APIREsponseErrorType | Error, messages?:Record<string, string>, fallbackMessage?: string): FormattedAPIErrorType => {
    ...
    return {
        ...
        message: messages?.[error.error.code] || fallbackMessage || DEFAULT_ERROR_MESSAGE,
    }
}
