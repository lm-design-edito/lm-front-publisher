...
type UseImageGenerateReturn = Awaited<ReturnType<typeof api.queries.images.generate>>
...
export function useImageGenerate(clbs?: {
    ...
    return useMutation({
        mutationFn: (params: UseImageGenerateParams) => api.queries.images.generate(params),
        onSuccess: (data) => {
            if (!data.success) {
