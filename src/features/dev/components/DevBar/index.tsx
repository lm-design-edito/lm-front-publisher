...
const DevBar = () => {
    ...
    const { mutate: debugRefreshToken, isPending: isPendingDebugRefreshToken } = useMutation({
        ...
        <div className="dev-bar__content">
            <div className="dev-bar__category">
                ...
                <div className="dev-bar__actions">
                    ...
                    <button onClick={() => debugRefreshToken()}>Refresh tokens {isPendingDebugRefreshToken && <Loader />}</button>
                </div>
            </div>
            <div className="dev-bar__category">
